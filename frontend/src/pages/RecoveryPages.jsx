...
function RecoveryShell({ page, user, logout, intro, children, cursorConfig }) {
  return (
    <SiteLayout
      page={page}
      user={user}
  ...
  return (
    <RecoveryShell
      ...
      intro={
        <AuthIntro
          eyebrow={
            verificationPaused ? "Verification paused" : "Email verification"
          }
          title={
            verificationPaused
    ...
    >
      <section className="auth-card">
        ...
        {hasVerified ? (
          <div className="token-box">
            <h3>
              {verificationPaused ? "Verification paused" : "Account verified"}
            </h3>
            <p>
              {verificationPaused
